/* This is a basic libcurl example for showing how to fetch a large amount of
 * data from the web (e.g. a very lage web page or some data). The large size
 * forces curl_easy_perform() to invoke the callback function multiple times.
 * The callback must be able to handle multiple invocations.
 */
#include <iostream>
#include <string.h>
#include <curl/curl.h>
